...
export const PPT_TEMPLATES = [
  {
    ...
    description: '适合清晰、专业的课程说明。',
    descriptionEn: 'Suitable for clear and professional course presentations.',
  ...
  },
  {
    ...
    description: '适合重点突出、节奏鲜明的课件。',
    descriptionEn: 'Suitable for focused courseware with a strong rhythm.',
  ...
  },
  {
    ...
    description: '适合更有空间感的展示。',
    descriptionEn: 'Suitable for spacious and atmospheric presentations.',
