 ...
 * 用法：node api/scripts/verify-yoga-pose-sync.mjs（需 Node 22+ 以直接加载 .ts）
 */
import { YOGA_POSES as tsPoses } from '../src/lib/experience/yogaPoses.ts';
import { YOGA_POSES as jsPoses } from '../../src/modules/creative-workshop/yogaPoses.js';
