...
export const PROMPT_META: Record<string, PromptMeta> = {
  ...
  'experience-yoga-plan': { description: '互动式情境瑜伽活动方案生成（工作室 step 2）', caller: 'creative-works/[id]/plan', kind: 'pair', source: 'builtin' },
  'experience-yoga-design': { description: '互动式情境瑜伽逐页设计生成（含体式与画面描述）', caller: 'creative-works/[id]/design', kind: 'pair', source: 'builtin' },
  'experience-music-song': { description: '星光录音棚歌曲创作（歌名+歌词时间轴+目标句型）', caller: 'creative-works/[id]/song', kind: 'pair', source: 'builtin' },
  'experience-music-exercises': { description: '星光录音棚第一关练习 + 四关教学方案生成（基于歌词）', caller: 'creative-works/[id]/exercises', kind: 'pair', source: 'builtin' },
