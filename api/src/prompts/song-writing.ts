...
返回严格 JSON：{ "title":"英文歌名", "words":["能填入歌词空格的英文词或短语，数量=空格数+2-3个干扰词"], "lines":["歌词行，含 ______ 标记空格位置；行数和音节严格遵循旋律硬约束"], "activityPlan":{"englishGoal":"可观察的语言目标", "wellbeingGoal":"可观察的幸福力目标", "materials":["材料"], "steps":[{"title":"环节名称", "duration":"分钟", "teacherGuide":"教师可直接说的引导语与学生动作"}]}}。活动方案按导入、学唱填词、合作表演、回顾四步输出，具体、可执行。`;
}
