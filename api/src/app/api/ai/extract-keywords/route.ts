...
- 禁止出现的内容：
  ...
  * 任何小动物（小猫、小狗、小兔子等）
- 示例：
  * 简单描述："夜晚的楼顶，rolly正在逗小猫玩" → 详细描述："夜晚的城市楼顶，深蓝色的夜空中繁星点点，明亮的月光洒在地面，远处是灯火辉煌的城市夜景，楼顶有护栏和几盆绿植，整体氛围宁静而浪漫"
  * 简单描述："校门口，校门打开着" → 详细描述："清晨的校园门口，柔和的晨光洒在红砖地面上，天空呈淡青色渐变为浅金，校门是深红色铁艺拱门，大门敞开着，两侧立着整齐的银杏树，枝叶初绿，门旁立有铜牌和一排盛开的粉色海棠花，地面干净整洁，整体氛围朝气蓬勃、宁静而充满希望"
