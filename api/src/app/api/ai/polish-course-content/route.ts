...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('[polish-course-content] 调用 N8N 工作流: course-content-polisher-v2');

    const result = await n8nClient.call('course-content-polisher-v2', {
      ...body,
      promptTemplate: await getRawTemplate('n8n.course-polish'),
    }, { timeout: 120000 });
